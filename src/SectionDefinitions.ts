...
export const WEAPON_ITEM_DEFINITIONS: Record<string, SectionDefinition> = {
    ...
    "Spirit Rend": new SectionDefinition("Spirit Rend", "", "", "/item_icons/weapon/spirit_rend", "", "", "", ""),
...
export const VITALITY_ITEM_DEFINITIONS: Record<string, SectionDefinition> = {
    "Extra Health": new SectionDefinition("Extra Health", "", "", "/item_icons/extra_health", "", "", "", ""),
    "Extra Regen": new SectionDefinition("Extra Regen", "", "", "/item_icons/extra_regen", "", "", "", ""),
    "Extra Stamina": new SectionDefinition("Extra Stamina", "", "", "/item_icons/extra_stamina", "", "", "", ""),
    "Healing Rite": new SectionDefinition("Healing Rite", "", "", "/item_icons/healing_rite", "", "", "", ""),
    "Melee Lifesteal": new SectionDefinition("Melee Lifesteal", "", "", "/item_icons/melee_lifesteal", "", "", "", ""),
    "Rebuttal": new SectionDefinition("Rebuttal", "", "", "/item_icons/rebuttal", "", "", "", ""),
    "Sprint Boots": new SectionDefinition("Sprint Boots", "", "", "/item_icons/sprint_boots", "", "", "", ""),

    "Battle Vest": new SectionDefinition("Battle Vest", "", "", "/item_icons/battle_vest", "", "", "", ""),
    "Bullet Lifesteal": new SectionDefinition("Bullet Lifesteal", "", "", "/item_icons/bullet_lifesteal", "", "", "", ""),
    "Debuff Reducer": new SectionDefinition("Debuff Reducer", "", "", "/item_icons/debuff_reducer", "", "", "", ""),
    "Enchanter's Emblem": new SectionDefinition("Enchanter's Emblem", "", "", "/item_icons/enchanters_emblem", "", "", "", ""),
    "Enduring Speed": new SectionDefinition("Enduring Speed", "", "", "/item_icons/enduring_speed", "", "", "", ""),
    "Guardian Ward": new SectionDefinition("Guardian Ward", "", "", "/item_icons/guardian_ward", "", "", "", ""),
    "Healbane": new SectionDefinition("Healbane", "", "", "/item_icons/healbane", "", "", "", ""),
    "Healing Booster": new SectionDefinition("Healing Booster", "", "", "/item_icons/healing_booster", "", "", "", ""),
    "Reactive Barrier": new SectionDefinition("Reactive Barrier", "", "", "/item_icons/reactive_barrier", "", "", "", ""),
    "Restorative Locket": new SectionDefinition("Restorative Locket", "", "", "/item_icons/restorative_locket", "", "", "", ""),
    "Return Fire": new SectionDefinition("Return Fire", "", "", "/item_icons/return_fire", "", "", "", ""),
    "Spirit Lifesteal": new SectionDefinition("Spirit Lifesteal", "", "", "/item_icons/spirit_lifesteal", "", "", "", ""),
    "Spirit Shielding": new SectionDefinition("Spirit Shielding", "", "", "/item_icons/spirit_shielding", "", "", "", ""),
    "Weapon Shielding": new SectionDefinition("Weapon Shielding", "", "", "/item_icons/weapon_shielding", "", "", "", ""),

    "Bullet Resilience": new SectionDefinition("Bullet Resilience", "", "", "/item_icons/bullet_resilience", "", "", "", ""),
    "Counterspell": new SectionDefinition("Counterspell", "", "", "/item_icons/counterspell", "", "", "", ""),
    "Debuff Remover": new SectionDefinition("Debuff Remover", "", "", "/item_icons/debuff_remover", "", "", "", ""),
    "Fortitude": new SectionDefinition("Fortitude", "", "", "/item_icons/fortitude", "", "", "", ""),
    "Fury Trance": new SectionDefinition("Fury Trance", "", "", "/item_icons/fury_trance", "", "", "", ""),
    "Healing Nova": new SectionDefinition("Healing Nova", "", "", "/item_icons/healing_nova", "", "", "", ""),
    "Lifestrike": new SectionDefinition("Lifestrike", "", "", "/item_icons/lifestrike", "", "", "", ""),
    "Majestic Leap": new SectionDefinition("Majestic Leap", "", "", "/item_icons/majestic_leap", "", "", "", ""),
    "Metal Skin": new SectionDefinition("Metal Skin", "", "", "/item_icons/metal_skin", "", "", "", ""),
    "Rescue Beam": new SectionDefinition("Rescue Beam", "", "", "/item_icons/rescue_beam", "", "", "", ""),
    "Spirit Resilience": new SectionDefinition("Spirit Resilience", "", "", "/item_icons/spirit_resilience", "", "", "", ""),
    "Stamina Mastery": new SectionDefinition("Stamina Mastery", "", "", "/item_icons/stamina_mastery", "", "", "", ""),
    "Trophy Collector": new SectionDefinition("Trophy Collector", "", "", "/item_icons/trophy_collector", "", "", "", ""),
    "Veil Walker": new SectionDefinition("Veil Walker", "", "", "/item_icons/veil_walker", "", "", "", ""),
    "Warp Stone": new SectionDefinition("Warp Stone", "", "", "/item_icons/warp_stone", "", "", "", ""),

    "Cheat Death": new SectionDefinition("Cheat Death", "", "", "/item_icons/cheat_death", "", "", "", ""),
    "Colossus": new SectionDefinition("Colossus", "", "", "/item_icons/colossus", "", "", "", ""),
    "Divine Barrier": new SectionDefinition("Divine Barrier", "", "", "/item_icons/divine_barrier", "", "", "", ""),
    "Diviner's Kevlar": new SectionDefinition("Diviner's Kevlar", "", "", "/item_icons/diviners_kevlar", "", "", "", ""),
    "Healing Tempo": new SectionDefinition("Healing Tempo", "", "", "/item_icons/healing_tempo", "", "", "", ""),
    "Infuser": new SectionDefinition("Infuser", "", "", "/item_icons/infuser", "", "", "", ""),
    "Inhibitor": new SectionDefinition("Inhibitor", "", "", "/item_icons/inhibitor", "", "", "", ""),
    "Juggernaut": new SectionDefinition("Juggernaut", "", "", "/item_icons/juggernaut", "", "", "", ""),
    "Leech": new SectionDefinition("Leech", "", "", "/item_icons/leech", "", "", "", ""),
    "Phantom Strike": new SectionDefinition("Phantom Strike", "", "", "/item_icons/phantom_strike", "", "", "", ""),
    "Plated Armor": new SectionDefinition("Plated Armor", "", "", "/item_icons/plated_armor", "", "", "", ""),
    "Siphon Bullets": new SectionDefinition("Siphon Bullets", "", "", "/item_icons/siphon_bullets", "", "", "", ""),
    "Spellbreaker": new SectionDefinition("Spellbreaker", "", "", "/item_icons/spellbreaker", "", "", "", ""),
    "Unstoppable": new SectionDefinition("Unstoppable", "", "", "/item_icons/unstoppable", "", "", "", ""),
    "Vampiric Burst": new SectionDefinition("Vampiric Burst", "", "", "/item_icons/vampiric_burst", "", "", "", ""),
    "Witchmail": new SectionDefinition("Witchmail", "", "", "/item_icons/witchmail", "", "", "", "")
};

export const SPIRIT_ITEM_DEFINITIONS: Record<string, SectionDefinition> = {
    "Extra Charge": new SectionDefinition("Extra Charge", "", "", "/item_icons/extra_charge", "", "", "", ""),
    "Extra Spirit": new SectionDefinition("Extra Spirit", "", "", "/item_icons/extra_spirit", "", "", "", ""),
    "Mystic Burst": new SectionDefinition("Mystic Burst", "", "", "/item_icons/mystic_burst", "", "", "", ""),
    "Mystic Expansion": new SectionDefinition("Mystic Expansion", "", "", "/item_icons/mystic_expansion", "", "", "", ""),
    "Mystic Regeneration": new SectionDefinition("Mystic Regeneration", "", "", "/item_icons/mystic_regeneration", "", "", "", ""),
    "Rusted Barrel": new SectionDefinition("Rusted Barrel", "", "", "/item_icons/rusted_barrel", "", "", "", ""),
    "Spirit Strike": new SectionDefinition("Spirit Strike", "", "", "/item_icons/spirit_strike", "", "", "", ""),

    "Arcane Surge": new SectionDefinition("Arcane Surge", "", "", "/item_icons/arcane_surge", "", "", "", ""),
    "Bullet Resist Shredder": new SectionDefinition("Bullet Resist Shredder", "", "", "/item_icons/bullet_resist_shredder", "", "", "", ""),
    "Cold Front": new SectionDefinition("Cold Front", "", "", "/item_icons/cold_front", "", "", "", ""),
    "Compress Cooldown": new SectionDefinition("Compress Cooldown", "", "", "/item_icons/compress_cooldown", "", "", "", ""),
    "Duration Extender": new SectionDefinition("Duration Extender", "", "", "/item_icons/duration_extender", "", "", "", ""),
    "Improved Spirit": new SectionDefinition("Improved Spirit", "", "", "/item_icons/improved_spirit", "", "", "", ""),
    "Mystic Slow": new SectionDefinition("Mystic Slow", "", "", "/item_icons/mystic_slow", "", "", "", ""),
    "Mystic Vulnerability": new SectionDefinition("Mystic Vulnerability", "", "", "/item_icons/mystic_vulnerability", "", "", "", ""),
    "Quicksilver Reload": new SectionDefinition("Quicksilver Reload", "", "", "/item_icons/quicksilver_reload", "", "", "", ""),
    "Slowing Hex": new SectionDefinition("Slowing Hex", "", "", "/item_icons/slowing_hex", "", "", "", ""),
    "Spirit Sap": new SectionDefinition("Spirit Sap", "", "", "/item_icons/spirit_sap", "", "", "", ""),
    "Suppressor": new SectionDefinition("Suppressor", "", "", "/item_icons/suppressor", "", "", "", ""),

    "Decay": new SectionDefinition("Decay", "", "", "/item_icons/decay", "", "", "", ""),
    "Disarming Hex": new SectionDefinition("Disarming Hex", "", "", "/item_icons/disarming_hex", "", "", "", ""),
    "Greater Expansion": new SectionDefinition("Greater Expansion", "", "", "/item_icons/greater_expansion", "", "", "", ""),
    "Knockdown": new SectionDefinition("Knockdown", "", "", "/item_icons/knockdown", "", "", "", ""),
    "Radiant Regeneration": new SectionDefinition("Radiant Regeneration", "", "", "/item_icons/radiant_regeneration", "", "", "", ""),
    "Rapid Recharge": new SectionDefinition("Rapid Recharge", "", "", "/item_icons/rapid_recharge", "", "", "", ""),
    "Silence Wave": new SectionDefinition("Silence Wave", "", "", "/item_icons/silence_wave", "", "", "", ""),
    "Spirit Snatch": new SectionDefinition("Spirit Snatch", "", "", "/item_icons/spirit_snatch", "", "", "", ""),
    "Superior Cooldown": new SectionDefinition("Superior Cooldown", "", "", "/item_icons/superior_cooldown", "", "", "", ""),
    "Superior Duration": new SectionDefinition("Superior Duration", "", "", "/item_icons/superior_duration", "", "", "", ""),
    "Surge of Power": new SectionDefinition("Surge of Power", "", "", "/item_icons/surge_of_power", "", "", "", ""),
    "Tankbuster": new SectionDefinition("Tankbuster", "", "", "/item_icons/tankbuster", "", "", "", ""),
    "Torment Pulse": new SectionDefinition("Torment Pulse", "", "", "/item_icons/torment_pulse", "", "", "", ""),

    "Arctic Blast": new SectionDefinition("Arctic Blast", "", "", "/item_icons/arctic_blast", "", "", "", ""),
    "Boundless Spirit": new SectionDefinition("Boundless Spirit", "", "", "/item_icons/boundless_spirit", "", "", "", ""),
    "Curse": new SectionDefinition("Curse", "", "", "/item_icons/curse", "", "", "", ""),
    "Echo Shard": new SectionDefinition("Echo Shard", "", "", "/item_icons/echo_shard", "", "", "", ""),
    "Escalating Exposure": new SectionDefinition("Escalating Exposure", "", "", "/item_icons/escalating_exposure", "", "", "", ""),
    "Ethereal Shift": new SectionDefinition("Ethereal Shift", "", "", "/item_icons/ethereal_shift", "", "", "", ""),
    "Focus Lens": new SectionDefinition("Focus Lens", "", "", "/item_icons/focus_lens", "", "", "", ""),
    "Lightning Scroll": new SectionDefinition("Lightning Scroll", "", "", "/item_icons/lightning_scroll", "", "", "", ""),
    "Magic Carpet": new SectionDefinition("Magic Carpet", "", "", "/item_icons/magic_carpet", "", "", "", ""),
    "Mercurial Magnum": new SectionDefinition("Mercurial Magnum", "", "", "/item_icons/mercurial_magnum", "", "", "", ""),
    "Mystic Reverb": new SectionDefinition("Mystic Reverb", "", "", "/item_icons/mystic_reverb", "", "", "", ""),
    "Refresher": new SectionDefinition("Refresher", "", "", "/item_icons/refresher", "", "", "", ""),
    "Scourge": new SectionDefinition("Scourge", "", "", "/item_icons/scourge", "", "", "", ""),
    "Spirit Burn": new SectionDefinition("Spirit Burn", "", "", "/item_icons/spirit_burn", "", "", "", ""),
    "Transcendent Cooldown": new SectionDefinition("Transcendent Cooldown", "", "", "/item_icons/transcendent_cooldown", "", "", "", ""),
    "Vortex Web": new SectionDefinition("Vortex Web", "", "", "/item_icons/vortex_web", "", "", "", "")
};
